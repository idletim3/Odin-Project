...
[Mozilla: IIFE](https://developer.mozilla.org/en-US/docs/Glossary/IIFE)

[Mozilla: Expressions and Operators](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_operators)

[Mozilla: Operator Precedence](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Operator_Precedence)
...
[JavaScript Info: Variable Tasks](https://javascript.info/variables#tasks)
[JavaScript Info: Operators](https://javascript.info/operators#tasks)